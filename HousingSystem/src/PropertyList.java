...
public class PropertyList {
	...
	public void addProperty(String[] amenities, String utilities, String location, int price, int beds, int baths, String description, String contact, boolean visible) {
