...
public class HousingUI {
	...
	// Prints a menu, where element 0 is the title and elements 1-menu.length are the items
	...
	// Parses the user input into an integer, returns that int if its between 1 and numCommands-1, else returns -1
